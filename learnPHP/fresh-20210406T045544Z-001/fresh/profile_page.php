  ...
  <div id="checkout-step-billing" class="step a-item" style="">
    <form id="co-billing-form">
      <fieldset class="group-select">
            ...
            <fieldset>
              ...
              <ul>
                ...
                <li>
                  ...
                  <br>
                  <textarea type="text" style="height: 10%;" title="Street Address" name="billing[street][]" id="billing_street1" class="input-text required-entry"><?php echo $_SESSION['user_details'][2]; ?></textarea>
                </li>
                <li>
                  <div class="input-box">
                ...
                <li>
                  <div class="input-box">
                    ...
                    <br>
                    <input type="text" readonly name="billing[telephone]" value="<?php echo $_SESSION['user_details'][7]; ?>" title="Telephone" class="input-text" id="billing_telephone">
                  </div>
                </li>
              </ul>
            </fieldset>
        ...
        <button type="button" class="button continue update_profile"><span>Update</span></button>
      </fieldset>
    </form>
  </div>
</li>
...
$(document).on('click', '.update_profile', function(){
  ...
  var address = $('#billing_street1').val();
  var city = $('#billing_city').val();
  var state = $('#billing_region_id').val();
  ...
  var country = $('#billing_country_id').val();
   ...
   $.ajax({
      ...
      method:"POST",
      data:{fn:fn, ln:ln, address:address, city:city, state:state, zipcode:zipcode, country:country},
      success:function(data)
      {
        alertify.set('notifier','position', 'bottom-left');
        alertify.success('Profile updated!', 1);
      }
   });
