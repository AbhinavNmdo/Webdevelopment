...
?>
                           ...
                           <tfoot>
                              <tr class="first last">
                                 <td class="a-right last" colspan="50"><button onclick="setLocation('index.php')" class="button btn-continue" title="Continue Shopping" type="button"><span>Continue Shopping</span></button>
                                    <button id="empty_cart_button" class="button btn-empty" title="Clear Cart" value="empty_cart" name="update_cart_action_delete" type="submit"><span>Clear Cart</span></button>
                                 </td>
                              </tr>
                           </tfoot>
                  ...
                  <div class="cart-collaterals row">
                     ...
                     <div class="col-sm-4">
                        <div class="totals">
                           ...
                           <div class="inner sub_total_panel">
                              <!-- load sub total panel here load_subtotalPanel.php -->
                           </div>
                           <!--inner--> 
                        </div>
                     </div>
      ...
      <script type="text/javascript">
         ...
         function load_subtotalPanels(){
            var numbers = <?php echo $_SESSION['wpnumb']; ?>;
