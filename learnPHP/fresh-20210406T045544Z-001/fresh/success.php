...
$razor_pay_id = isset($_REQUEST['razorpay_payment_id'])?$_REQUEST['razorpay_payment_id']:"";
...
foreach ($rows as $row) {
   ...
   'orderType'=>'BANK',
   'orderTransactionID'=>$razor_pay_id,
...
<html lang="en">
   <head>
      ...
      <title>thedailyfreshstore | Order successfully placed.</title>
      <!-- Mobile Specific -->
                     ...
                     <div class="col-xs-6 hidden-xs">
                        ...
                        <div class="toplinks">
                           <div class="links">
                              ...
                              <div class="check"><a title="Logout" href="success.php?logout=true"><span class="hidden-xs">Logout</span></a> </div>
                           </div>
                        </div>
